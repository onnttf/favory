...
interface CollectionRow {
  ...
  created_at: string
  updated_at: string
  bookmark_count?: number  // optional, added by queries that include it
}
...
// POST /collection/list — returns all collections with cumulative bookmark counts
export async function handleCollectionList(
  ...
  return json({ collections }, 200, corsHeaders)
}
